...
app_name = 'projects'
from .views import ProjectListView, ProjectDetailView, CompleteProjectView, ToggleParticipateView, ProjectCreateView, ProjectEditView, ToggleFavoriteView
...
urlpatterns = [
    ...
    path('<int:pk>/toggle-favorite/', ToggleFavoriteView.as_view(), name='project-toggle-favorite'),

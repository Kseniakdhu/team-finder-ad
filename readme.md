...
# TeamFinder — платформа для поиска команды и совместной работы над проектами

**TeamFinder** — это веб-приложение на Django, где пользователи могут создавать проекты, искать единомышленников, присоединяться к командам, делиться навыками и контактами. Поддерживается публичный профиль, фильтрация по навыкам, избранное, а также управление проектами и участниками.
